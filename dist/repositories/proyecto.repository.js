...
let ProyectoRepository = class ProyectoRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource) {
        super(models_1.Proyecto, dataSource);
    }
};
ProyectoRepository = __decorate([
